...
async def get_facultad(id_facultad: int):
    return nueva_facultad.get_facultad(id_facultad)
...
async def delete_facultad(id_facultad: int):
    ...
    facultad = nueva_facultad.get_facultad(id_facultad)
